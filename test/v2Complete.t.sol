...
// import { NounsPlayableCitizen } from "../src/v2/NounsPlayableCitizen.sol";
// import { NounsPlayableCitizenTrait, INounsPlayableCitizenTrait } from "../src/v2/NounsPlayableCitizenTrait.sol";


// /// @title CompleteTest for v2 (conner's version).
// /// @author frog @0xmcg
// /// @notice E2E test for v2 (conner's version).
// contract V2CompleteTest is Test {
//     address public caller = address(1);
//     ERC6551Registry public registry;
//     ERC6551Account public accountImpl;
//     Easel public easel;
//     NounsPlayableCitizen public nounsPlayableCitizen;
//     NounsPlayableCitizenTrait public nounsPlayableCitizenTrait;
...
//       easel = new Easel();
//       nounsPlayableCitizenTrait = new NounsPlayableCitizenTrait(address(easel));
//       nounsPlayableCitizen = new NounsPlayableCitizen(
//         address(nounsPlayableCitizenTrait), // traits
//         address(easel), // easel
//         address(registry), // 6551 registry
//         address(accountImpl), // 6551 impl
//         bytes32(0) // 6551 salt
//       );
...
//       INounsPlayableCitizenTrait(address(nounsPlayableCitizenTrait)).registerTrait(body, "body");
//       INounsPlayableCitizenTrait(address(nounsPlayableCitizenTrait)).registerTrait(glasses, "glasses");
//       vm.stopPrank();
//     }
...
//       address tbaAddress = registry.account(address(accountImpl), bytes32(0), block.chainid, address(nounsPlayableCitizen), tokenId);
//       IERC1155Rails(address(nounsPlayableCitizenTrait)).mintTo(tbaAddress, 1, 1);
//       IERC1155Rails(address(nounsPlayableCitizenTrait)).mintTo(tbaAddress, 2, 1);

//       INounsPlayableCitizenTrait(address(nounsPlayableCitizenTrait)).setEquippedTokenIds(tbaAddress, tokenIds);
//       assertEq(ERC721Rails(nounsPlayableCitizen).name(), "Noun Citizens");
//       assertEq(ERC721Rails(nounsPlayableCitizen).tokenURI(tokenId), headGlassesSVG);
//       assertEq(ERC721Rails(nounsPlayableCitizen).contractURI(), "TEMP_CONTRACT_URI");
//       vm.stopPrank();
//     }
// }
